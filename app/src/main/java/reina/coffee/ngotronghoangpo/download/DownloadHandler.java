 ...
 */
package reina.coffee.ngotronghoangpo.download;
...
public class DownloadHandler {
    ...
    private void onDownloadStartNoStream(@NonNull final Activity context, @NonNull PreferenceManager preferences,
        ...
        reina.coffee.ngotronghoangpo.download.WebAddress webAddress;
        try {
            webAddress = new reina.coffee.ngotronghoangpo.download.WebAddress(url);
