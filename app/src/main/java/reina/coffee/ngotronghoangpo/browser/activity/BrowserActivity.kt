...
package reina.coffee.ngotronghoangpo.browser.activity

import reina.coffee.ngotronghoangpo.BrowserApp
import reina.coffee.ngotronghoangpo.IncognitoActivity
import reina.coffee.ngotronghoangpo.R
import reina.coffee.ngotronghoangpo.browser.*
...
import reina.coffee.ngotronghoangpo.dialog.DialogItem
...
import reina.coffee.ngotronghoangpo.interpolator.BezierDecelerateInterpolator
...
import reina.coffee.ngotronghoangpo.settings.activity.SettingsActivity
import reina.coffee.ngotronghoangpo.utils.*
import reina.coffee.ngotronghoangpo.view.Handlers
import reina.coffee.ngotronghoangpo.view.LightningView
import reina.coffee.ngotronghoangpo.view.SearchView
...
//            showCloseDialog(it.positionOf(currentTab))
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val gso = GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
                .requestIdToken("462292482911-sqdktq76vmvg211hhcs4dsigs8m66ig3.apps.googleusercontent.com")
                .requestEmail()
                .build()

        mGoogleApiClient = GoogleApiClient.Builder(this)
//                .enableAutoManage(this /* FragmentActivity */, GoogleApiClient.OnConnectionFailedListener /* OnConnectionFailedListener */)
